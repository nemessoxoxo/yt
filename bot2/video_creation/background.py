...
def download_background():
    ...
    if not Path("C:/Users/karol/Desktop/CashCows/AskReddit/background.mp4").is_file():
        print_step(
        ...
        ydl_opts = {
            "outtmpl": "C:/Users/karol/Desktop/CashCows/AskReddit/background.mp4",
...
def chop_background_video(video_length):
    ...
    background = VideoFileClip("C:/Users/karol/Desktop/CashCows/AskReddit/background.mp4")

    start_time, end_time = get_start_and_end_times(video_length, background.duration)
    ffmpeg_extract_subclip(
        "C:/Users/karol/Desktop/CashCows/AskReddit/background.mp4",
        start_time,
        end_time,
